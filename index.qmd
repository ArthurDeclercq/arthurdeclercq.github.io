...
<div id="main-content" class="main-content">
  ...
  <section id="about" class="about-section max-widht">
    <div class="about-text">
      <h2>About Me</h2>
        <p>Despite the space-themed presentation, this is not an astronomy website. Rather, it marks one of the happiest and most meaningful milestones of my career: presenting my doctoral research to family and close friends and receiving my PhD in Health Sciences. I began in Biomedical Sciences, where I discovered a strong interest in immunology and informatics; at their intersection, I completed a master’s degree and embarked on a PhD. During my doctoral work, I developed artificial intelligence methods to study protein fragments—epitopes—presented by cells via major histocompatibility complex (MHC) molecules. These epitopes provide critical insight for the design of effective vaccines against infectious diseases and cancer.</p>
        <p>When I am away from my desk, I am usually on the move. Running is my primary hobby—on city routes with the Ghent Running Crew or on longer trail courses. I also enjoy backpacking and spending nights in my tent and recently picked up photography. When I do slow down, it is often with a good book (often a good space opera).</p>
        <p>Welcome to my website. If you have questions or would like to connect, please feel free to reach out.</p>
    </div>
  </section>
