...
format:
  html:
    ...
    include-in-header:
      text: |
        <link rel="icon" type="image/png" href="icons/AD_logo_small.png" />
        <link rel="shortcut icon" href="icons/AD_logo_small.png" />
        <link rel="apple-touch-icon" href="icons/AD_logo_small.png" />
---
...
<nav class="navbar">
  ...
  <div class="logo-container">
    <img src="icons/AD_logo_small.png" alt="ADeclercq logo" class="logo">
  </div>
...
<section id="home" class="home-section">
  <div class="hero-content">
    <div class="hero-name-block">
      <div class="hero-name-bar"></div>
      <div class="hero-name-text">
        <div class="hero-first">Arthur</div>
        <div class="hero-last">Declercq</div>
      </div>
    </div>
    <div class="hero-rule"></div>
    <p class="hero-tagline">Researcher · Runner · Photographer</p>
  </div>
</section>

<!-- Photographer Credit Box (outside home-section to remain clickable) -->
<div class="photo-credit home-photo-credit">Photo by <a href="https://jasperzuallaert.com/" target="_blank">Jasper Zuallaert</a></div>
...
<div id="main-content" class="main-content">
  ...
  <section id="about" class="about-section max-widht">
    <div class="about-text">
      <h2>About Me</h2>
        <p>Despite the space-themed landing, this is not an astronomy website. It marks one of the happiest milestones of my career: defending my doctoral research in front of family and close friends, and receiving my PhD in Health Sciences.
        I started out in Biomedical Sciences, where I fell for immunology in the lab. Somewhere along the way I also fell for code, and the two collided in a master's at their intersection, and then in a PhD. My doctoral work focused on building artificial intelligence methods to study epitopes—small protein fragments that cells present on MHC molecules, essentially a molecular "here is what is going on inside me" signal to the immune system. Reading that signal well is key to designing better vaccines, both against infectious diseases and cancer.</p>
        <p>When I step away from the desk, I am usually moving. Running comes first, whether that is fast city kilometres or longer, quieter trails when I need to reset. Close behind is <a href="arluxis.html">ARLUXIS.</a>—my own photography brand—where I channel a more creative side of me and document wherever I go with my camera. Beyond that, I hike and camp whenever I can, and when I do finally sit still, it is usually with a good book in hand, often a space opera.</p>
        <p>Welcome to my site. If you would like to connect, talk science, or swap trail recommendations, feel free to reach out.</p>
    </div>
  </section>
  ...
  <section id="experience" class="experience-section">
    <div class="max-widht">
      ...
      <div class="current-position">
        ...
        <p class="current-position-text"><strong>Postdoctoral Researcher</strong> at <a href="https://vib.be/en/research-and-impact/research-centers/center-medical-biotechnology#/" target="_blank">VIB-UGent Center for Medical Biotechnology</a><br><span>2024 – Present</span></p>
        <blockquote>"Working on data-driven bioinformatics solutions for mass spectrometry-based immunopeptidomics & immunoinformatics."</blockquote>
      </div>
  ...
  <!-- Education Section -->
      <div class="education-section">
        ...
        <ul class="education-list">
          <li>
            <strong>Postdoc in immunoinformatics</strong> – VIB<br>
            <span>2025 – ...</span>
          </li>
          <li>
            <strong>PhD in Health Sciences</strong> – Ghent University<br>
            <span>2021 – 2025</span>
          </li>
          <li>
      ...
      <div class="prizes-section">
        <h3>Prizes & Awards</h3>
        <ul class="education-list">
          <li class="prize-item prize-gold">
            <strong>Winner Best Thesis in Health Sciences</strong> – Ghent University <span>|</span> <span>2026</span>
            <div style="margin-left: 20px; margin-top: 5px;">
              <span class="prize-description">"Epitope Odyssey: Data-driven tools to extend the known immunopeptide universe"
            </span>
            </div>
          </li>
          <li class="prize-item prize-gold">
            <strong>Winner PhD Innovation Café</strong> – VOKA & Ghent university <span>|</span> <span>2023</span>
            <div style="margin-left: 20px; margin-top: 5px;">
              <span class="prize-description">PhD students pitch their research to relevant companies</span>
            </div>
          </li>
              <li class="prize-item prize-silver">
                <strong>Second Place Best Presentation Award</strong> – French Proteomic Society <span>|</span> <span>2023</span>
                <div style="margin-left: 20px; margin-top: 5px;">
                  <span class="prize-description">Flash talk at the 16th Club Jeune Days</span>
                </div>
              </li>
        </ul>
      </div>
      ...
      <div class="skills-section">
        ...
        <div class="skills-list">
          ...
          <span class="skill-item">Immunoinformatics</span>
  ...
  <section id="voka-section" class="voka-section">
    <div class="voka-background">
      ...
      <div class="voka-quote">
        <h2>“Meetinstrumenten in de biotechwereld worden elke dag beter, met onze software proberen we de ontwikkeling van mRNA-vaccins een duwtje in de rug te geven.”</h2>
        
        <!-- Link button with icon -->
        <a href="images/VOKA_article.pdf"
          class="voka-link" target="_blank">
          <span class="link-icon">🔗</span> <!-- Link icon -->
          Read Article
        </a>
      </div>
    </div>
...
<section id="publications" class="publications-section">
  <div class="max-widht">
    ...
    <!-- Tims²Rescore -->
    <div class="publication-item" data-year="2025-02" data-first-author="true">
      <h3 class="publication-title">TIMS²Rescore: A DDA-PASEF optimized data-driven rescoring pipeline based on MS²Rescore</h3>
    ...
    <!-- MHCquant 2 -->
    <div class="publication-item" data-year="2024-12" data-first-author="false">
        <h3 class="publication-title">MHCquant2 refines immunopeptidomics tumor antigen discovery</h3>
        <p class="publication-authors">
          <strong>Authors:</strong> Jonas Scheid ∙ Steffen Lemke ∙ Naomi Hoenisch-Gravel ∙ Anna Dengler ∙ Timo Sachsenberg ∙ Arthur Declerq ∙ Ralf Gabriels ∙ Jens Bauer ∙ Marcel Wacker ∙ Leon Bichmann ∙ Lennart Martens ∙ Marissa L. Dubbelaar ∙ Sven Nahnsen ∙ Juliane S. Walz
        </p>
        <p class="publication-journal">
    ...
    <!-- IM2Deep -->
    <div class="publication-item" data-year="2025-02" data-first-author="false">
        <h3 class="publication-title">Collisional cross-section prediction for multiconformational peptide ions with IM2Deep</h3>
        <p class="publication-authors">
          <strong>Authors:</strong> Robbe Devreese ∙ Alireza Nameni ∙ Arthur Declercq, Emmy Terryn ∙ Ralf Gabriels ∙ Francis Impens ∙ Kris Gevaert ∙ Lennart Martens ∙ Robbin Bouwmeester
        </p>
        <p class="publication-journal">
          <strong>Journal:</strong> Biorxiv<span>|</span> <strong>Year:</strong> February 2025 <span>|</span> 
          <span class="abstract-container" onclick="toggleAbstract(this)">
            Abstract
            <img src="icons/document.png" alt="abstract Icon" class="abstract-icon">
          </span>
        ...
        <div class="abstract">
          <p class="abstract-text">Peptide collisional cross-section (CCS) prediction is complicated by the tendency of peptide ions to exhibit multiple conformations in the gas phase. This adds further complexity to downstream analysis of proteomics data, for example for identification or quantification through feature finding. Here, we present an improved version of IM2Deep that is trained on a carefully curated dataset to predict CCS values of multiconformational peptides. The training data is derived from a large and comprehensive set of publicly available datasets. This comprehensive training dataset together with a tailored architecture allows for the accurate CCS prediction of multiple peptide conformational states. Furthermore, the enhanced IM2Deep model also retains high precision for peptides with a single observed conformation. IM2Deep is publicly available under a permissive open source license at <a href="https://github.com/compomics/IM2Deep" target="_blank" class="manuscript-link">https://github.com/compomics/IM2Deep</a>.</p>
          <a href="https://www.biorxiv.org/content/10.1101/2025.02.18.638865v1" target="_blank" class="manuscript-link">
            View Manuscript
          </a>
        </div>
      </div>
    ...
    <!-- ms2rescore metaproteomics -->
    <div class="publication-item" data-year="2025-02" data-first-author="false">
        <h3 class="publication-title">Boosting metaproteomics identification rates and taxonomic specificity with MS2Rescore</h3>
        <p class="publication-authors">
          <strong>Authors:</strong> Tim Van Den Bossche ∙ Arthur Declercq ∙ Ralf Gabriels ∙ Tanja Holstein ∙ Bart Mesuere ∙ Thilo Muth ∙ Pieter Verschaffelt ∙ Lennart Martens
        </p>
        <p class="publication-journal">
          <strong>Journal:</strong> Biorxiv<span>|</span> <strong>Year:</strong> February 2025 <span>|</span> 
          <span class="abstract-container" onclick="toggleAbstract(this)">
    ...
    <div class="publication-item" data-year="2025-03" data-first-author="false">
      <h3 class="publication-title">Maximizing immunopeptidomics-based bacterial epitope discovery by multiple search engines and rescoring</h3>
      <p class="publication-authors">
          <strong>Authors:</strong> Patrick Willems ∙ Fabien Thery ∙ Laura Van Moortel ∙ Margaux De Meyer ∙ An Staes ∙ Adillah Gul ∙ Lyudmila Kovalchuke ∙ Arthur Declercq ∙ Robbe Devreese ∙ Robbin Bouwmeester ∙ Ralf Gabriels ∙  Lennart Martens ∙ Francis Impens
      </p>
      <p class="publication-journal">
        <strong>Journal:</strong> Journal of Proteome Research<span>|</span> <strong>Year:</strong> March 2025 <span>|</span> 
        <span class="abstract-container" onclick="toggleAbstract(this)">
          Abstract
          <img src="icons/document.png" alt="abstract Icon" class="abstract-icon">
        </span>
      ...
      <div class="abstract">
          ...
          <a href="https://pubs.acs.org/doi/10.1021/acs.jproteome.4c00864" target="_blank" class="manuscript-link">
          View Manuscript
          </a>
      </div>
    </div>
    ...
    <!-- MS²Rescore MCP -->
    <div class="publication-item" data-year="2022-08" data-first-author="true">
      <h3 class="publication-title">MS2Rescore: Data-Driven Rescoring Dramatically Boosts Immunopeptide Identification Rates</h3>
      <p class="publication-authors">
    ...
    <!-- MS²Rescore MSAmanda -->
  <div class="publication-item" data-year="2024-03" data-first-author="true">
  <h3 class="publication-title">MS2Rescore 3.0 Is a Modular, Flexible, and User-Friendly Platform to Boost Peptide Identifications, as Showcased with MS Amanda 3.0</h3>
  <p class="publication-authors">
  ...
  <!-- MS²PIP -->
  <div class="publication-item" data-year="2023-07" data-first-author="true">
  <h3 class="publication-title">Updated MS²PIP web server supports cutting-edge proteomics applications</h3>
  <p class="publication-authors">
  ...
  <!-- Thunder PASEF -->
  <div class="publication-item" data-year="2024-03" data-first-author="false">
  <h3 class="publication-title">Thunder-DDA-PASEF enables high-coverage immunopeptidomics and is boosted by MS2Rescore with MS2PIP timsTOF fragmentation prediction model</h3>
  <p class="publication-authors">
  ...
  <div class="publication-item" data-year="2024-06" data-first-author="true">
  <h3 class="publication-title">Bioinformatics Pipeline for Processing Single-Cell Data</h3>
  <p class="publication-authors">
  ...
  <!-- PSM Utils -->
  <div class="publication-item" data-year="2022-12" data-first-author="false">
  <h3 class="publication-title">Psm_utils: A high-level Python API for parsing and handling peptide-spectrum matches and proteomics search results</h3>
  <p class="publication-authors">
  ...
  <!-- Ionmob -->
  <div class="publication-item" data-year="2023-08" data-first-author="false">
  <h3 class="publication-title">Ionmob: a Python package for prediction of peptide collisional cross-section values</h3>
  <p class="publication-authors">
  ...
  <!-- PP plot -->
  <div class="publication-item" data-year="2023-01" data-first-author="false">
  <h3 class="publication-title">Quality control for the target decoy approach for peptide identification</h3>
  <p class="publication-authors">
      <strong>Authors:</strong> Elke Debrie ∙ Milan Malfait ∙ Ralf Gabriels ∙ Arthur Declercq ∙ Adriaan Sticker ∙ Lennart Martens ∙ Lieven Clement 
  </p>
  <p class="publication-journal">
  ...
  <!-- cross-links -->
  <div class="publication-item" data-year="2024-04" data-first-author="false">
  <h3 class="publication-title">Intensity and retention time prediction improves the rescoring of protein-nucleic acid cross-links</h3>
  <p class="publication-authors">
  ...
  <!-- transfer learning -->
  <div class="publication-item" data-year="2026-02" data-first-author="false">
  <h3 class="publication-title">Transfer learning in DeepLC improves LC retention time prediction across substantially different modifications and setups</h3>
  <p class="publication-authors">
      <strong>Authors:</strong> Robbin Bouwmeester ∙ Alireza Nameni ∙ Arthur Declercq ∙ Robbe Devreese ∙ Kevin Velghe ∙ Vladimir Gorshkov ∙ Pelayo A. Penanes ∙ Frank kjeldsen ∙ Magali Rompais ∙ Christine Carapito ∙ Ralf Gabriels & Lennart Martens 
  </p>
  <p class="publication-journal">
      <strong>Journal:</strong> Nature Communications<span>|</span> <strong>Year:</strong> February 2026 <span>|</span> 
        <span class="abstract-container" onclick="toggleAbstract(this)">
          Abstract
          <img src="icons/document.png" alt="abstract Icon" class="abstract-icon">
        </span>
  <div class="abstract">
      <p class="abstract-text">While LC retention time prediction of peptides and their modifications has proven useful, widespread adoption and optimal performance are hindered by variations in experimental parameters. These variations can render retention time prediction models inaccurate and dramatically reduce the value of predictions for identification, validation, and DIA spectral library generation. To date, mitigation of these issues has been attempted through calibration or by training bespoke models for specific experimental setups, with only partial success. We here demonstrate that transfer learning can successfully overcome these limitations by leveraging pre-trained model parameters. Remarkably, this approach can even fit highly performant models to substantially different peptide modifications and LC conditions than those on which the model was originally trained. This impressive adaptability of transfer learning makes it a highly robust solution for accurate peptide retention time prediction across a very wide variety of imaginable proteomics workflows.</p>
      <a href="https://www.nature.com/articles/s41467-026-68981-5" target="_blank" class="manuscript-link">
      View Manuscript
      </a>
  </div>
  </div>
  ...
  <section id="projects" class="projects-section max-widht">
    ...
    <div class="projects-container">
      ...
      <div class="project-card">
        <h3 class="project-title">MS²Rescore</h3>
      ...
      <!-- MS²PIP -->
      <div class="project-card">
        <h3 class="project-title">MS²PIP</h3>
      ...
      <!-- Mumble -->
      <div class="project-card">
        <h3 class="project-title">Mumble</h3>
      ...
      <!-- MHC-3PO -->
      <div class="project-card">
        <h3 class="project-title">MHC-3PO</h3>
      ...
      <!-- Baxerna -->
      <div class="project-card">
        <h3 class="project-title">Baxerna</h3>
      ...
      <!-- ARLUXIS -->
      <div class="project-card">
        <h3 class="project-title">ARLUXIS</h3>
        <p class="project-description">My photography journey - exploring light, moments, and perspectives.</p>
        <a href="arluxis.html" class="project-link">View Portfolio</a>
      </div>
...
<!-- All scripts -->
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      ...
      publications.forEach((pub) => {
        let yearData = pub.getAttribute("data-year");

        if (yearData) {
          // Handle both "YYYY-MM" and "YYYY" formats
          let pubDate = null;
          if (yearData.match(/^\d{4}-\d{2}$/)) {
            pubDate = new Date(`${yearData}-01`);
          } else if (yearData.match(/^\d{4}$/)) {
            pubDate = new Date(`${yearData}-01-01`);
          }
          ...
          if (pubDate) {
            ...
            if (diffDays <= newThreshold) {
              ...
              if (title && !title.querySelector(".new-tag")) {
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      const container = document.querySelector(".publications-section .max-widht");
      ...
      items.sort((a, b) => {
        const aFirst = a.dataset.firstAuthor === "true" ? 0 : 1;
        const bFirst = b.dataset.firstAuthor === "true" ? 0 : 1;

        // Sort first by first-authorship, then by date (descending)
        if (aFirst !== bFirst) {
      ...
      // Append sorted items and new dividers
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    // Find the last first-author publication
    let lastFirstAuthorIndex = -1;
    publications.forEach((pub, index) => {
      if (pub.dataset.firstAuthor === "true") {
        lastFirstAuthorIndex = index;
      }
    });

    // If we found at least one first-author publication and there's a divider after it
    if (lastFirstAuthorIndex !== -1 && lastFirstAuthorIndex < publications.length - 1) {
      const lastFirstAuthor = publications[lastFirstAuthorIndex];
      const divider = lastFirstAuthor.nextElementSibling;

      if (divider && divider.classList.contains("divider")) {
        // Change the divider color
        divider.style.backgroundColor = "#dba14d";
        divider.style.height = "1px"; // Optional: make it a bit thicker
      }
    }
  });
</script>
